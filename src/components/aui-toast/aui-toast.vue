<template name="aui-toast">
	<!-- 有图标 -->
	<div class="aui-toast aui-toast-middle" :class="{'aui-toast-row': direction=='row'}" v-if="SHOW && icon">
		<div class="aui-toast-main">
			<div class="aui-toast-icon"><img :src="icon" /></div>
			<div class="aui-toast-msg" v-html="msg"></div>
		</div>
	</div>
	<!-- 无图标 -->
	<div class="aui-toast" :class="{'aui-toast-bottom': location=='bottom', 'aui-toast-middle': location=='middle'}" v-else-if="SHOW && !icon">
		<div class="aui-toast-main">
			<div class="aui-toast-msg" v-html="msg"></div>
		</div>
	</div>
