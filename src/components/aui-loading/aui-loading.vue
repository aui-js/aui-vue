<template>
	<!-- 1、常用loading加载弹窗 -->
	<div class="aui-loading aui-loading-ring" :class="{ 'aui-loading-ring-row': direction == 'row' }" v-if="SHOW && type == 1">
		<div class="aui-mask" v-if="mask"></div>
		<div class="aui-loading-main">
			...
			<div class="aui-loading-msg" v-if="msg">{{ msg }}</div>
		</div>
	</div>
	<!-- 2、按钮内显示loading加载动画 -->
	<div class="aui-loading aui-loading-button" v-else-if="SHOW && type == 2">
		<div class="aui-loading-main" :style="{ background: styles.background, borderRadius: styles.borderRadius, zIndex: styles.zIndex }">
			<div class="aui-loading-warp">
				<div class="aui-loading-animate">
					<div class="span" :style="{ borderColor: styles.color }"></div>
					<div class="span" :style="{ borderColor: styles.color }"></div>
					<div class="span" :style="{ borderColor: styles.color }"></div>
					<div class="span" :style="{ borderColor: styles.color }"></div>
					<div class="span" :style="{ borderColor: styles.color }"></div>
				...
				<div class="aui-loading-msg" v-if="msg" :style="{ color: styles.color }">{{ msg }}</div>
			</div>
		</div>
	</div>
	...
	<div
		...
		:class="{ 'aui-loading-squarefour-style-1': theme == 1, 'aui-loading-squarefour-style-2': theme == 2 }"
		v-else-if="SHOW && type == 3"
	>
		<div class="aui-mask" v-if="mask"></div>
		<div class="aui-loading-main" :style="{ background: styles.background, zIndex: styles.zIndex }">
			<div class="aui-loading-animate">
				<div class="span1"></div>
				<div class="span2"></div>
				<div class="span3"></div>
	...
	<div class="aui-loading aui-loading-dots" v-else-if="SHOW && type == 4">
		<div class="aui-mask" v-if="mask"></div>
		<div class="aui-loading-main">
			<div class="aui-loading-dot-items">
				<div class="aui-loading-dot-item dot_one"></div>
				<div class="aui-loading-dot-item dot_two"></div>
				<div class="aui-loading-dot-item dot_three"></div>
			</div>
		</div>
	</div>
	<!-- 5、三圆点背景过度(全屏首次加载过度动画) -->
	<div class="aui-loading aui-loading-dots-opacity" v-else-if="SHOW && type == 5">
		<div class="aui-mask" v-if="mask"></div>
		<div class="aui-loading-main">
			<div class="aui-loading-dot-items">
				<div class="aui-loading-dot-item dot_one"></div>
...
.aui-loading.aui-loading-squarefour .aui-loading-animate div {
	width: 12px;
	height: 12px;
	display: block;
	border-radius: 2px;
